...
Put the robot in the start box, unplug the cable, and hold OK.
...
Now change `STRAIGHT_1_SECONDS` until the robot stops level with the cone. Bigger number, further out. You should have this one in two or three tries.

## Step 3: Type in WORK 2

The curve. This is the new part.

Add two more numbers at the top, under `STRAIGHT_1_SECONDS`:
...
**`ARC_SECONDS` sets how far around it goes.** Robot ends up still pointing sideways? More seconds. Turned too far and pointing back at the cone? Fewer seconds.
