...
# Features: Graphical UI, Bitmasking, Analog Triggers, Inverted Y-Axis
#
# Version: V08
# FIX: Restored the Graphical User Interface (Grid/Table) from commit 7eeb.
# FIX: Increased safety timeout to 3000.0 seconds (3s) to prevent 'Link Lost'.
# FIX: Parsing logic now supports the '/update' URL structure.
...
"""
    ...
    def is_connected(self):
        """Returns True if a valid packet was received in the last 3.0 seconds."""
        # V08 FIX: Increased to 300.0 (5 minutes) to handle network jitter
